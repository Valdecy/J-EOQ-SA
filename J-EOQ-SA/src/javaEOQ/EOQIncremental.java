...
public class EOQIncremental {
	
	public EOQIncremental (){
	...
	public double holdingCost(double q, double[] qa,  int[] y, double[] C, double I) {
		...
		hc1 = y[1]*I*((C[0]*qa[0] + C[1]*qa[1])/2);
		hc2 = y[2]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2])/2);
		hc3 = y[3]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3])/2);
		hc4 = y[4]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3] + C[4]*qa[4])/2);
		hc5 = y[5]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3] + C[4]*qa[4] + C[5]*qa[5])/2);
		hc6 = y[6]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3] + C[4]*qa[4] + C[5]*qa[5] + C[6]*qa[6])/2);
		hc7 = y[7]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3] + C[4]*qa[4] + C[5]*qa[5] + C[6]*qa[6] + C[7]*qa[7])/2);
		hc8 = y[8]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3] + C[4]*qa[4] + C[5]*qa[5] + C[6]*qa[6] + C[7]*qa[7] + C[8]*qa[8])/2);
		hc9 = y[9]*I*((C[0]*qa[0] + C[1]*qa[1] + C[2]*qa[2] + C[3]*qa[3] + C[4]*qa[4] + C[5]*qa[5] + C[6]*qa[6] + C[7]*qa[7] + C[8]*qa[8] + C[9]*qa[9])/2);
